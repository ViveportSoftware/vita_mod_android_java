...
public class AndroidBase64Test {
    ...
    public void default_0_getInstance() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
        Assert.assertTrue(base64 instanceof AndroidBase64);

        base64 = Base64.getInstance(AndroidBase64.class);
        Assert.assertNotNull(base64);
        Assert.assertTrue(base64 instanceof AndroidBase64);
    }

    @Test
    public void default_1_encodeToString() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
    ...
    @Test
    public void default_1_encodeToString_withBasicOption() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
    ...
    @Test
    public void default_1_encodeToString_withMimeOption() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
    ...
    @Test
    public void default_1_encodeToString_withUrlSafeOption() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
    ...
    @Test
    public void default_2_decode() throws UnsupportedEncodingException {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
    ...
    @Test
    public void default_2_decode_withBasicOption() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
    ...
    @Test
    public void default_2_decode_withMimeOption() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
    ...
    @Test
    public void default_2_decode_withUrlSafeOption() {
        Base64.register(AndroidBase64.class);
        Base64 base64 = Base64.getInstance();
        Assert.assertNotNull(base64);
